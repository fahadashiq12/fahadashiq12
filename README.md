...
<ul> 🚀 A Software Development Engineer - Web Developer with a good grip on research & development proficient in front-end and backend development technologies including HTML5, Vue.js, CSS3, WebFlow, Wordprress, Bootstrap5, JavaScript along with grip on backend framework .NET , MS-SQL & OOAD Design. </ul>
<ul> ⚡ I have recently Participated in Y combinator Summer School Program 2021. </ul>
<ul> 🔭 I am currently working as Software Engineer @Enghouse Interactive in Research & Development Department. </ul>
