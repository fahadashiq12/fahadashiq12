...
<ul> ⚡️ A Web Developer with a good grip on basic front-end development tools including HTML5, CSS3, Bootstrap and JavaScript along with grip on backend framework .NET , MySQL, and OOP Concepts. </ul>
