...
<ul> 🚀 A Junior Software Engineer - Web Developer with a good grip on Research & Development and front-end development technologies and backend including HTML5, Vue.js,CSS3, WebFlow, Wordprress, Bootstrap5, Tailwind and JavaScript along with grip on backend framework .NET , MS-SQL & OOAD Design </ul>
